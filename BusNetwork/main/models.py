...
class Route(Document):
    #def __init__(self, rNumber, rName, depCity, depCityCode, destCity, destCode, rType, depTimeHours, depTimeMin, tTimeHours, tTimeMin):
        ...
        routeName = StringField(max_length=80, required=False, verbose_name="Route name")
        ...
        destinationCity = StringField(max_length=120, required=True, verbose_name="Destination City")
